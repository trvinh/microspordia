...
data <- read.table("/home/vinh/Desktop/data/project/iniAnalysis/length_median.stat", sep='\t',header=T)
...
png("/home/vinh/Desktop/data/project/iniAnalysis/length_median.stat.png", width=1600, height=800)
