...
data <- read.table("/home/vinh/Desktop/data/project/iniAnalysis/results/lengthTest/homologous_vs_orphan.LEN.list", sep='\t',header=T)
...
png("/home/vinh/Desktop/data/project/iniAnalysis/results/lengthTest/homologous_vs_orphan.LEN.png", width=800, height=800)
